...
$(document).ready(function() {
  ...
  var FinalizePrev = function() {
    if ($(".canves").html() === "") {
      ...
      $("#style-sheet").val("\n" + $(".canves").children().text("").parent().html().replace(/<\/?/g,'').replace(/h1 /g,'').replace(/div /g,'').replace(/header /g,'').replace(/footer /g,'').replace(/class="/g,'.').replace(/div/g,'').replace(/span/g,'').replace(/header/g,'').replace(/footer/g,'').replace(/style="/g,'{\n  ').replace(/;/g,';\n ').replace(/"/g,'').replace(/ >>/g,'}').replace(/>>/g,' {}').replace(/ }/g,'}\n').replace(/}./g,'}\n.').replace(/&quot;\n /g,"'").replace(/&quot;/g,"'") + "\n");
  ...
  $(window).on('load', function() {
    ...
    $(".canves").children().prop('contenteditable', false).removeAttr('contenteditable');
  ...
  $("#select-tool").on('click touchstart', function() {
  ...
  $(function() {
    ...
    $(function() {
      ...
      $("#clearinputs").on('click touchend', function() {
        if ($("#stylethis").is(":visible")) {
      ...
      $(".editselectedelm").on('click touchend', function() {
        EditableStylez();
      });
      ...
      $("#add-button").on('click touchend', function() {
      ...
      $("#add-textbox").on('click touchend', function() {
        $(this).toggleClass('thisisanactivebutton');
        if ($('.thisisanactivebutton').is(':visible')) {
      ...
      $("#add-parent").on('click touchend', function() {
        $(this).toggleClass('thisisanactivebutton');
        if ($('.thisisanactivebutton').is(':visible')) {
      ...
      $("#add-child").on('click touchend', function() {
        $(this).toggleClass('thisisanactivebutton');
        if ($('.thisisanactivebutton').is(':visible')) {
      ...
      $(".clear-canves-properz .imaclearyourcanvas").on('click touchend', function() {
      ...
      $(".clear-canves-properz .imaclearyourselectedelm").on('click touchend', function() {
      ...
      $(".clear-canves-properz .imaclearallyourcss").on('click touchend', function() {
      ...
      $(".add-button-properz .add-button-confirm").on('click touchend', function() {
        if ($('#stylethis').is(":visible")) {
          if ($('.newbtntxt').val() === "") {
      ...
      $(".add-textbox-properz .add-textbox-confirm").on('click touchend', function() {
        if ($('#stylethis').is(":visible")) {
      ...
      $(".add-child-properz .add-child-confirm, #custom-menu .add-child-confirm").on('click touchend', function() {
        if ( $("#stylethis").is(":visible") ) {
          if ( $("#stylethis").html() === "" ) {
      ...
      $(".add-parent-properz .add-parent-confirm, #custom-menu .add-parent-confirm").on('click touchend', function() {
        if ( $("#stylethis").is(":visible") ) {
          if ( $("#stylethis").html() === "" ) {
    ...
    $(function() {
      ...
      $(".ancordaposvalz a").on('click touchend', function() {
      ...
      $("#width-identifier").on('click touchend', function() {
        if ( $(this).text() === "%" ) {
          $(this).text("px");
      ...
      $("#height-identifier").on('click touchend', function() {
        if ( $(this).text() === "%" ) {
          $(this).text("px");
        } else if ( $(this).text() === "px" ) {
          $(this).text("%");
    ...
    $(function() {
      ...
      $("#grab-txt-align a").on('click touchend', function() {
      ...
      $(".grab-default-typography a").on('click touchend', function() {
  ...
  $(function() {
    $("#exit-edit-mode").on('click touchend', function() {
      $(".canves *").prop('contenteditable', false).removeAttr('contenteditable');
    ...
    // Handles Heading
    $('#editable-heading-elms a').on('click touchend', function() {
      document.execCommand('formatBlock', false, $(this).text());
      $("#show-editable-elms-code").val($(editableElm).html());
      localStorage.setItem('CanvesContent', $(".canves").html());
    });
    $('#editable-elms a').on('click touchend', function() {
      $("#show-editable-elms-code").val($(editableElm).html());
      localStorage.setItem('CanvesContent', $(".canves").html());
    });
    ...
    // Handles Typography
    $(function() {
      $('#editable-font-type a').on('click touchend', function() {
        document.execCommand('FontName', false, $(this).text());
        $("#show-editable-elms-code").val($(editableElm).html());
        localStorage.setItem('CanvesContent', $(".canves").html());
      });
      $('#editable-txt-align a').on('click touchend', function() {
      ...
      $('#add-editable-font-color').on('click touchend', function() {
      ...
      $("#grab-editable-txt-color").on('click touchend', function() {
  ...
  $("#css-tips").on('click touchstart', function() {
    $(this).toggleClass("myfukentoolisactivebiotch");
  ...
  $("#toggle-themes").on('click touchstart', function() {
  ...
  $(".adds-your-css-selector").on('click touchend', function() {
  ...
  $("#new-doc").on('click touchend', function() {
    $("#menu").hide();
    ...
    if (x) {
      ...
      $("#js-code").val("$(document).ready(function() {\n  \n});");
      $("#cwidth").attr('max', $("#itsthecavnescontainerbro").width()).val($("#itsthecavnescontainerbro").width());
      $("#resolutionoptimzer").val($("#cwidth").width() + "px").trigger("change");
  ...
  $("#export-your-html").on('click touchend', function() {
    $("#menu").hide();
    FinalizePrev();
    if ($("#select-tool.myfukentoolisactivebiotch").is(':visible')) {
  ...
  $(function() {
    ...
    // Web Browser
    $(function() {
      $("#browseweb-back").on('click touchend', function() {
        history.back();
      });
      $("#browseweb-forward").on('click touchend', function() {
        history.forward();
      });
    ...
    $(".elms-4-stage").find(".add-elm").on('click touchend', function() {
  ...
  $(function() {
    ...
    $(function() {
      ...
      $(".adds-your-font-color").on('mousedown focus', function(e) {
    ...
    $(function() {
      ...
      $(".adds-your-background-color").on('mousedown focus', function(e) {
    ...
    $(function() {
      ...
      $(".adds-your-border-top").on('mousedown focus', function(e) {
    ...
    $(function() {
      ...
      $(".adds-your-border-left").on('mousedown focus', function(e) {
    ...
    $(function() {
      ...
      $(".adds-your-border-right").on('mousedown focus', function(e) {
    ...
    $(function() {
      ...
      $(".adds-your-border-bottom").on('mousedown focus', function(e) {
  ...
  $("#search-mmd").on('click touchend', function() {
    if ($('#select-tool.myfukentoolisactivebiotch').is(':visible')) {
      $("#search-app").val("none").trigger('change').val("").focus();
    } else {
      $("#select-tool").trigger('click');
